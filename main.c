     ...
     switch(r1)
		...
		if (toupper(getch())=='B')
			...
			break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is B.Gujrat");
		       getch();
		       break;}

        case 3:
		printf("\n\n\nPlant receive their nutrients mainly from?");
		printf("\n\nA.Chorophyll\t\tB.Atmosphere\n\nC.Light\t\tD.Soil");
		if (toupper(getch())=='D')
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		...
		if (toupper(getch())=='B')
			...
			getch();
			 break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is B.Sadbhavana Divas");
		       getch();
		       break;}
		...
		printf("\n\nA.Amritsar\t\tB.New Delhi\n\nC.Mumbai\t\tD.Agra");
		if (toupper(getch())=='A' )
			{printf("\n\nCorrect!!!");count++;
			getch();
			break;}
		else
		       {printf("\n\nWrong!!! The correct answer is A.Amritsar");
		       getch();
		       break;}}
		       }
...
game:
     ...
     switch(r)
		...
		printf("\n\nA.Oder of significance\t\tB.Open Software\n\nC.Operating System\t\tD.Optical sensor");
		if (toupper(getch())=='C')
		...
		if (toupper(getch())=='A')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		       ...
		       {printf("\n\nWrong!!! The correct answer is A.Graphite");getch();
		      goto score;
		       break;
		       }
		...
		printf("\n\nA.electrons and neutrons\t\tB.protons and neutrons\n\nC.electrons and protons\t\tD.All of the above");
		if (toupper(getch())=='B')
			{printf("\n\nCorrect!!!");countr++;getch();
			 break;}
		else
		       {
                printf("\n\nWrong!!! The correct answer is B.protons and neutrons");getch();
		       goto score;
		       break;
		       }
